...
function handleErrorForFloatDiv(error, element, position, width, height) {
	...
	// 拼装信息展示区的内容
	//上方浮动DIV,默认上方浮动
	var msgHtml = "<div class='zx_xiak'  id='" + errorIdDiv + "'><div style='width:228px;  padding:2px 0 0 8px; color:#ff0000; font-size:11px;'><p>"
	...
	if (position == 'top') {
		...
		var top = offset.top;
		//右边浮动DIV
		msgHtml = "<div class='hx_kuang' id='" + errorIdDiv + "'><p style='color:red'>"
		+ errorMsg + "</p></div>";
